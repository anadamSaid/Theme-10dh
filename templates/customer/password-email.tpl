...
{block name='page_content'}
  <form id="Forget_Password" action="{$urls.pages.password}" class="forgotten-password" method="post">
    ...
    <header>
      <p class="send-renew-password-link">{l s='We will send you an email to reset your password.' d='Shop.Theme.Customeraccount'}</p>
    </header>
