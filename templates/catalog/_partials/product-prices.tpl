        ...
        <div class="current-price">
          ...
          {if $product.has_discount}
            {if $product.discount_type === 'percentage'}
              <span class="discount discount-percentage"><span class="material-icons-outlined">local_offer</span>{l s='Save %percentage%' d='Shop.Theme.Catalog' sprintf=['%percentage%' => $product.discount_percentage_absolute]}</span>
            {else}
