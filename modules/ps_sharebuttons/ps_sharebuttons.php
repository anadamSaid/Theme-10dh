...
class Ps_Sharebuttons extends Module implements WidgetInterface
{
    ...
    protected static $networks = ['Facebook', 'Twitter', 'Pinterest' ,'Whatsapp', 'gmail'];
    ...
    public function install()
    {
        if (!$this->uninstallPrestaShop16Module()) {
            ...
            Configuration::updateValue('PS_SC_GMAIL', 1);
        }
    ...
    public function getWidgetVariables($hookName, array $params)
    {
        if (!method_exists($this->context->controller, 'getProduct')) {
            ...
            $sharing_url = _PS_BASE_URL_."/TestNewTheme/module/WishListModule/fcont" ;
            ...
            if (Configuration::get('PS_SC_TWITTER')) {
                $social_share_links['twitter'] = [
                    ...
                    'class' => 'twitter',
                    'url' => 'https://twitter.com/intent/tweet?text='.$sharing_url,
                ];
            }
            ...
            if (Configuration::get('PS_SC_PINTEREST')) {
                $social_share_links['pinterest'] = [
                    ...
                    'class' => 'pinterest',
                    'url' => 'https://www.pinterest.com/pin/create/button/?media='.'&url='.$sharing_url,
                ];
            }
            ...
            if (Configuration::get('PS_SC_GMAIL')) {
                $social_share_links['gmail'] = [
                    'label' => $this->trans('gmail', [], 'Modules.Sharebuttons.Shop'),
                    'class' => 'gmail',
                    'url' => 'mailto:?subject=Unisex%20Tank%20Top%20-%20White%20w/%20Purple%20Debutterfly&amp;body='.$sharing_url ,
                ];
            }
        ...
        if (Configuration::get('PS_SC_GMAIL')) {
            $social_share_links['gmail'] = [
                'label' => $this->trans('gmail', [], 'Modules.Sharebuttons.Shop'),
                'class' => 'gmail',
                'url' => 'mailto:?subject=Unisex%20Tank%20Top%20-%20White%20w/%20Purple%20Debutterfly&amp;body='.$sharing_url.'%0D%0DUnisex%20Tank%20Top%20-%20White%20w/%20Purple%20Debutterfly%20%E2%80%94%20Ready%20to%20hit%20the%20court?%20Show%20those%20other%20players%20what%20a%20winner%20is%20made%20of?%20Hold%20it%20right%20there!%20If...%0D' ,
            ];
        }
