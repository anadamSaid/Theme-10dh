...
<div id="post-product-comment-modal" class="modal fade product-comment-modal" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <button type="button" class="btn quickview-close-button" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
        <form id="post-product-comment-form" action="{$post_comment_url nofilter}" method="POST">
          <div class="row">
            ...
            <div class="col-md-4 col-sm-4 pnanddesc">
              <h3>{$product.name}</h3>
  ...
  <div class="comment-modal-overlay" data-dismiss="modal"></div>
</div>
