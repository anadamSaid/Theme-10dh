...
<template>
  <div class="wishlist-products-container">
    ...
    <section
      ...
      <div id="ContainerWishListModule">
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      // let test = document.getElementById('ContainerWishListModule'); 
      // test.innerHTML += ` {if $page.page_name =='product' || $page.page_name =='module-WishListModule-fcont' }
