...
<div class="wishl">
	...
	<span class="wimg"><svg width="15px" height="14px"><use xlink:href="#hwish"></use></svg> <span>{l s='wishlist' mod='blockwishlist'}</span></span>{* <span class="cart-wishlist-number">{$count_product}</span> *}
	</a>
</div>
