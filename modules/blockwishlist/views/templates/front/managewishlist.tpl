...
{if $products}
                        ...
                        <div class="">
                            <div class="product_infos">
                                ...
                                <div class="product-name">
                                   <a href="{$link->getProductlink($product.id_product, $product.link_rewrite, $product.category_rewrite)|escape:'html':'UTF-8'}" title="{l s='Product detail' mod='blockwishlist'}"> {$product.name|truncate:30:'...'|escape:'html':'UTF-8'}</a>
                                    ...
                                    {if $wishlists|count > 1}
                                        {foreach name=wl from=$wishlists item=wishlist}
                                            {if $smarty.foreach.wl.first}
                                                <a class="btn btn-primary button button-small wishlist_change_button" tabindex="0" data-toggle="popover" data-trigger="focus" title="{l s='Move to a wishlist' mod='blockwishlist'}" data-placement="bottom">
    ...
    {if !$refresh}
        ...
        <a id="hideSendWishlist" class="button_account btn icon"  href="#" onclick="WishlistVisibility('wl_send', 'SendWishlist'); return false;" rel="nofollow" title="{l s='Close this wishlist' mod='blockwishlist'}">
            ...
            {* <fieldset>
                <div class="required form-group float-xs-left">
                    <label for="email1" class="float-xs-left">{l s='Email' mod='blockwishlist'}1 <sup>*</sup></label>
