...
$(".arrowleft").click(function() {
  ...
  // //owlCarrosel of product that are Promo
  ...
  // var owlBestSellers = $('#Best_Sellers .owl-carousel');
  ...
  //     }
  // });
  // $('#next_btn_BestSellers').click(function() {
  //     owlBestSellers.trigger('next.owl.carousel');
  // });
  // $('#prev_btn_BestSellers').click(function() {
