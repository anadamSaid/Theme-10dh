...
$(document).ready(() => {
  ...
  $("#CtmAccountMenu").parent().children().clone().appendTo(".drawer-signin .user-info");
  $(".promo-input").on("input", function() {
    if($(this).val().length){
      $(".voucher-btn-primary").addClass("voucher-active");
      $(".voucher-btn-primary").prop("disabled", false);
    }else{
      $(".voucher-btn-primary").prop("disabled", true);
      $(".voucher-btn-primary").removeClass("voucher-active");
    }
 });
});
